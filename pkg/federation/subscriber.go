...
type Handler func(remoteUnleashes []client.Object, adminSecret *corev1.Secret, namespaces []string, status pb.Status) error
...
func (s *subscriber) handleMessage(ctx context.Context, msg *pubsub.Message, handler Handler) error {
	...
	return handler(remoteUnleashes, adminSecret, instance.Namespaces, instance.Status)
}
