...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReleaseChannelActiveBatch) DeepCopyInto(out *ReleaseChannelActiveBatch) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReleaseChannelActiveBatch.
func (in *ReleaseChannelActiveBatch) DeepCopy() *ReleaseChannelActiveBatch {
	if in == nil {
		return nil
	}
	out := new(ReleaseChannelActiveBatch)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ReleaseChannelStatus) DeepCopyInto(out *ReleaseChannelStatus) {
	*out = *in
	...
	if in.InstanceImages != nil {
		in, out := &in.InstanceImages, &out.InstanceImages
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.LastTargetImages != nil {
		in, out := &in.LastTargetImages, &out.LastTargetImages
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.ActiveBatch != nil {
		in, out := &in.ActiveBatch, &out.ActiveBatch
		*out = new(ReleaseChannelActiveBatch)
		(*in).DeepCopyInto(*out)
	}
...
func (in *ReleaseChannelStrategy) DeepCopyInto(out *ReleaseChannelStrategy) {
	*out = *in
	...
	if in.MaxUpgradeTime != nil {
		in, out := &in.MaxUpgradeTime, &out.MaxUpgradeTime
		*out = new(v1.Duration)
		**out = **in
	}
}
