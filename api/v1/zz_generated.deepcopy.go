...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UnleashVerticalPodAutoscalerConfig) DeepCopyInto(out *UnleashVerticalPodAutoscalerConfig) {
	*out = *in
	...
	if in.ExtraPolicies != nil {
		in, out := &in.ExtraPolicies, &out.ExtraPolicies
		*out = make([]autoscaling_k8s_iov1.ContainerResourcePolicy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UnleashVerticalPodAutoscalerConfig.
func (in *UnleashVerticalPodAutoscalerConfig) DeepCopy() *UnleashVerticalPodAutoscalerConfig {
	if in == nil {
		return nil
	}
	out := new(UnleashVerticalPodAutoscalerConfig)
	in.DeepCopyInto(out)
	return out
}
